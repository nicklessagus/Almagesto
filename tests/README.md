...
El lint tiene **62 categorías**; el generador sintético sabe sembrar **16 anomalías**, y
...
Los tres números (62 categorías, 16 anomalías, 4 de ruido declarado) **salen del código, no de acá**:
