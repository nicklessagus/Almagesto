...
El lint tiene **105 categorías**; el generador sintético sabe sembrar **16 anomalías**, y
`test_conteos_exactos` puede afirmar *"reporta exactamente estos K, ni uno más"* sólo sobre esas.
El resto queda cubierto de otra forma —el corpus limpio tiene que dar **cero en las 105** salvo cuatro
...
Los tres números (105 categorías, 16 anomalías, 4 de ruido declarado) **salen del código, no de acá**:
