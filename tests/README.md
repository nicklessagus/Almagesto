...
| `test_lint.py` | cada categoría con su caso sembrado + exit codes; espejo ficha↔ground-truth campo por campo (#70), extraído pero no sintetizado (#75) | bóvedas mínimas por escenario |
