...
El resto queda cubierto de otra forma —el corpus limpio tiene que dar **cero en las 121** salvo cuatro
...
Los tres números (121 categorías, 16 anomalías, 4 de ruido declarado) **salen del código, no de acá**:
