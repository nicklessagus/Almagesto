...
El lint tiene **128 categorías**; el generador sintético sabe sembrar **16 anomalías**, y
`test_conteos_exactos` puede afirmar *"reporta exactamente estos K, ni uno más"* sólo sobre esas.
El resto queda cubierto de otra forma —el corpus limpio tiene que dar **cero en las 128** salvo cuatro
...
Los tres números (128 categorías, 16 anomalías, 4 de ruido declarado) **salen del código, no de acá**:
