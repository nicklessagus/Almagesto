...
def test_registro_real_cubre_los_118():
    """Contra el contrato REAL del repo: el parser tiene que leer los 118 invariantes vivos. Es la
    ...
    assert len(reg) == 118
    assert "INV-01" in reg and "INV-118" in reg
