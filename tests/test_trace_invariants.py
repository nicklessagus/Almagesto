...
def test_registro_real_cubre_los_103():
    """Contra el contrato REAL del repo: el parser tiene que leer los 103 invariantes vivos. Es la
    ...
    assert len(reg) == 103
    assert "INV-01" in reg and "INV-103" in reg
