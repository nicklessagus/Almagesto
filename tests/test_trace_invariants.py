...
def test_registro_real_cubre_los_124():
    """Contra el contrato REAL del repo: el parser tiene que leer los 124 invariantes vivos. Es la
    ...
    assert len(reg) == 124
    assert "INV-01" in reg and "INV-124" in reg
