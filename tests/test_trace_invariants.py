...
def test_registro_real_cubre_los_164():
    """Contra el contrato REAL del repo: el parser tiene que leer los 164 invariantes vivos. Es la
    ...
    assert len(reg) == 164          # 155 → 164 el 2026-09-22: INV-156…164 (AUD-435…439, §3.L)
