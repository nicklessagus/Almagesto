...
def test_registro_real_cubre_los_104():
    """Contra el contrato REAL del repo: el parser tiene que leer los 104 invariantes vivos. Es la
    ...
    assert len(reg) == 104
    assert "INV-01" in reg and "INV-104" in reg
