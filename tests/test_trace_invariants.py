...
def test_registro_real_cubre_los_120():
    """Contra el contrato REAL del repo: el parser tiene que leer los 120 invariantes vivos. Es la
    ...
    assert len(reg) == 120
    assert "INV-01" in reg and "INV-120" in reg
