...
def test_registro_real_cubre_los_119():
    """Contra el contrato REAL del repo: el parser tiene que leer los 119 invariantes vivos. Es la
    ...
    assert len(reg) == 119
    assert "INV-01" in reg and "INV-119" in reg
