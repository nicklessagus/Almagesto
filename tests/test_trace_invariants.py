...
def test_registro_real_cubre_los_107():
    """Contra el contrato REAL del repo: el parser tiene que leer los 107 invariantes vivos. Es la
    ...
    assert len(reg) == 107
    assert "INV-01" in reg and "INV-107" in reg
