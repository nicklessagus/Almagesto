...
def test_registro_real_cubre_los_117():
    """Contra el contrato REAL del repo: el parser tiene que leer los 117 invariantes vivos. Es la
    ...
    assert len(reg) == 117
    assert "INV-01" in reg and "INV-117" in reg
