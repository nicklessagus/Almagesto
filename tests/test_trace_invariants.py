...
def test_registro_real_cubre_los_96():
    """Contra el contrato REAL del repo: el parser tiene que leer los 96 invariantes vivos. Es la
    ...
    assert len(reg) == 96
    assert "INV-01" in reg and "INV-96" in reg
