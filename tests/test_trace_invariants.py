...
def test_registro_real_cubre_los_116():
    """Contra el contrato REAL del repo: el parser tiene que leer los 116 invariantes vivos. Es la
    ...
    assert len(reg) == 116
    assert "INV-01" in reg and "INV-116" in reg
