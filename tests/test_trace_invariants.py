...
def test_registro_real_cubre_los_109():
    """Contra el contrato REAL del repo: el parser tiene que leer los 109 invariantes vivos. Es la
    ...
    assert len(reg) == 109
    assert "INV-01" in reg and "INV-109" in reg
