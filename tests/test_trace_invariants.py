...
def test_registro_real_cubre_los_121():
    """Contra el contrato REAL del repo: el parser tiene que leer los 121 invariantes vivos. Es la
    ...
    assert len(reg) == 121
    assert "INV-01" in reg and "INV-121" in reg
