...
def test_registro_real_cubre_los_123():
    """Contra el contrato REAL del repo: el parser tiene que leer los 123 invariantes vivos. Es la
    ...
    assert len(reg) == 123
    assert "INV-01" in reg and "INV-123" in reg
