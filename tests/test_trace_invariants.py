...
def test_registro_real_cubre_los_114():
    """Contra el contrato REAL del repo: el parser tiene que leer los 114 invariantes vivos. Es la
    ...
    assert len(reg) == 114
    assert "INV-01" in reg and "INV-114" in reg
