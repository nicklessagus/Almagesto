...
def test_registro_real_cubre_los_106():
    """Contra el contrato REAL del repo: el parser tiene que leer los 106 invariantes vivos. Es la
    ...
    assert len(reg) == 106
    assert "INV-01" in reg and "INV-106" in reg
