...
def test_registro_real_cubre_los_122():
    """Contra el contrato REAL del repo: el parser tiene que leer los 122 invariantes vivos. Es la
    ...
    assert len(reg) == 122
    assert "INV-01" in reg and "INV-122" in reg
