...
## Barrido full-text (2b) sin rastro: no consta que la segunda red para el punto ciego de la query se haya tendido (backlog) (3)
- star00 → el barrido full-text (2b) no consta en el registro: es el único camino para los surveys que TABULAN la estrella sin nombrarla en el abstract → `python scripts/query_ads.py star00 --sweep`
- star01 → el barrido full-text (2b) no consta en el registro: es el único camino para los surveys que TABULAN la estrella sin nombrarla en el abstract → `python scripts/query_ads.py star01 --sweep`
- star02 → el barrido full-text (2b) no consta en el registro: es el único camino para los surveys que TABULAN la estrella sin nombrarla en el abstract → `python scripts/query_ads.py star02 --sweep`
