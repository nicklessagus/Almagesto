...
- Con implementación marcada: **10**
- Con test marcado: **10** (techo `sin_test`: 81, hoy 81)
- Sin ninguna marca: **81** (techo `sin_marca`: 81)
- Marcas huérfanas: **0**
...
| **INV-76** | P0 | HUECO (D-1) | — | — |
| **INV-77** | P1 | HUECO (D-2) | — | — |
| **INV-78** | P0 | HUECO (D-4, D-20) | `scripts/lib_blocks.py:3`<br>`scripts/lint.py:850` · `main` | `tests/test_lib_blocks.py:47` · `test_reflow_no_mueve_ancla`<br>`tests/test_lint.py:1862` · `test_reemplazo_del_txt_marca_por_fuente` |
| **INV-79** | P0 | HUECO (D-4, D-5) | `scripts/lint.py:850` · `main` | `tests/test_lint.py:1817` · `test_nota_verificada_no_marca_nada` |
| **INV-80** | P0 | HUECO (D-6) | `scripts/lib_config.py:203` · `objective_error`<br>`scripts/query_ads.py:838` · `main` | `tests/test_lib_config.py:399` · `test_objective_error_distingue_los_tres_estados`<br>`tests/test_lint.py:1735` · `test_lint_objective_roto_bloquea`<br>`tests/test_query_ads.py:1320` · `test_query_ads_rehusa_lente_vacia` |
...
| **INV-83** | P0 | HUECO (D-13, D-14) | `scripts/lib_config.py:592` · `save_extraccion` | `tests/test_lint.py:1970` · `test_subconjunto_sin_declarar_reporta` |
...
| **INV-89** | P1 | HUECO (D-28) | `scripts/lib_config.py:645` · `load_busquedas` | `tests/test_lib_config.py:418` · `test_dos_busquedas_con_solapamiento_no_suman` |
...
| **INV-91** | P1 | HUECO (D-57) | `scripts/lib_config.py:711` · `load_cadena`<br>`scripts/lib_config.py:716` · `save_paso` | `tests/test_lib_config.py:457` · `test_save_paso_appendea_con_fecha_version_y_via` |
