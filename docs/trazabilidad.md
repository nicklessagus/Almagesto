...
- Invariantes en el contrato: **104**
- Con implementación marcada: **83**
- Con test marcado: **101** (techo `sin_test`: 3, hoy 3)
...
|---|---|---|---|---|
| **INV-01** | P0 | garantizado sin medir | `scripts/make_notes.py:1754` · `write_star_note` | `tests/test_make_notes.py:298` · `test_star_note_desde_ground_truth` |
...
| **INV-07** | P0 | garantizado y medido | `scripts/make_notes.py:1754` · `write_star_note` | `tests/test_make_notes.py:325` · `test_star_note_sin_ground_truth` |
| **INV-08** | P0 | garantizado y medido | `scripts/make_notes.py:699` · `sync_mirror` | `tests/test_make_notes.py:1766` · `test_sync_mirror_no_pisa_un_valor_distinto` |
...
| **INV-11** | P0 | garantizado y medido | `scripts/make_notes.py:1000` | `tests/test_make_notes.py:596` · `test_inventario_no_tiene_columna_de_valor_adoptado` |
...
| **INV-13** | P0 | garantizado y medido | `scripts/lint.py:523` · `legacy_disputes`<br>`scripts/make_notes.py:613` · `migrate_all_bearing` | `tests/test_lint.py:1073` · `test_schema_viejo_de_disputes_grita_en_vez_de_volverse_mudo`<br>`tests/test_lint.py:1996` · `test_topics_en_nota_de_paper_es_schema_viejo` |
...
| **INV-15** | P0 | garantizado y medido | `scripts/make_notes.py:1426` · `_reemplazar_seccion` | `tests/test_make_notes.py:1797` · `test_sync_mirror_no_toca_la_prosa` |
| **INV-16** | P0 | garantizado y medido | `scripts/make_notes.py:812` · `merge_frontmatter_list` | `tests/test_make_notes.py:168` · `test_merge_preserva_el_resto_byte_a_byte` |
| **INV-17** | P1 | parcial (medido, con la deuda nombrada) | `scripts/make_notes.py:255` · `find_header_line` | `tests/test_make_notes.py:1338` · `test_find_header_line_es_contrato_compartido` |
| **INV-18** | P0 | garantizado y medido | `scripts/make_notes.py:283` · `stamp_pdf_link` | `tests/test_make_notes.py:1271` · `test_stamp_pdf_link_sin_cabecera_no_adivina` |
...
| **INV-26** | P1 | garantizado sin medir | `scripts/make_notes.py:86` · `_txt_provenance` | `tests/test_make_notes.py:963` · `test_fulltext_info_provenance` |
| **INV-27** | P1 | HUECO (parcial) | `scripts/fetch_web.py:46` | `tests/test_fetch_web.py:60` · `test_citekey_re` |
| **INV-28** | P1 | garantizado y medido | `scripts/extract_fulltext.py:80` · `is_legible`<br>`scripts/extract_fulltext.py:124` · `is_garbled` | `tests/test_extract_fulltext.py:49` · `test_legible_umbrales_limite` |
| **INV-29** | P0 | garantizado y medido | `scripts/make_notes.py:129` · `pdf_source_info` | `tests/test_make_notes.py:1447` · `test_pdf_source_desconocido_no_afirma_publicado` |
...
| **INV-35** | P0 | garantizado y medido | `scripts/make_notes.py:1322` · `concept_rollup_rows` | `tests/test_make_notes.py:1945` · `test_papers_table_no_depende_del_plugin` |
...
| **INV-58** | P1 | garantizado y medido | `scripts/lib_config.py:1316` · `lens_diff_offline`<br>`scripts/query_ads.py:872` · `reclass_diff` | `tests/test_lint.py:2350` · `test_lente_igual_calla`<br>`tests/test_lint.py:2361` · `test_lente_cambiada_reporta_diff_por_ficha`<br>`tests/test_query_ads.py:952` · `test_reclass_diff_reporta_el_delta` |
| **INV-59** | P0 | garantizado y medido | `scripts/query_ads.py:956` · `print_probe` | `tests/test_query_ads.py:978` · `test_reclass_diff_no_escribe_nada`<br>`tests/test_query_ads.py:1627` · `test_probe_no_escribe_nada` |
...
| **INV-61** | P1 | garantizado y medido | `scripts/make_notes.py:2099` · `write_web_paper_note` | `tests/test_fetch_web.py:151` · `test_force_rebaja_la_fuente_pero_no_pisa_la_extraccion`<br>`tests/test_ingest_theme.py:253` · `test_offads_pending_deriva_sin_fallar`<br>`tests/test_make_notes.py:2581` · `test_excluded_table_no_lanza_con_un_ads_json_cortado_a_media_letra` |
| **INV-62** | P1 | garantizado y medido | `scripts/make_notes.py:951` | `tests/test_lib_config.py:112` · `test_version_unica_fuente`<br>`tests/test_make_notes.py:2318` · `test_la_nota_declara_su_version`<br>`tests/test_make_notes.py:2332` · `test_restamp_headers_no_reetiqueta_la_nota` |
...
| **INV-64** | P0 | garantizado y medido (los 5 cambios, 1.35.0) | `scripts/make_notes.py:544` · `migrate_all_facets`<br>`scripts/make_notes.py:586` · `migrate_all_registros`<br>`scripts/make_notes.py:633` · `migrate_all_disputes` | `tests/poblada/test_invariantes_instancia.py:334` · `test_papers_declaran_facets_no_topics`<br>`tests/poblada/test_upgrade.py:129` · `test_vintage_bloquea_con_categorias_de_schema_viejo_y_receta_visible`<br>`tests/test_make_notes.py:2362` · `test_migrate_facets_renombra_y_es_idempotente`<br>`tests/test_make_notes.py:2391` · `test_migrate_registros_pliega_sin_perder_la_corrida` |
...
| **INV-70** | P1 | garantizado sin medir | `scripts/extract_fulltext.py:150` · `ocr_available` | `tests/test_extract_fulltext.py:210` · `test_flag_ocr_sin_tesseract_aborta` |
...
| **INV-80** | P0 | garantizado y medido | `scripts/lib_config.py:268` · `yaml_error`<br>`scripts/lib_config.py:284` · `stars_error`<br>`scripts/lib_config.py:289` · `themes_error`<br>`scripts/lib_config.py:305` · `objective_error`<br>`scripts/query_ads.py:989` · `main` | `tests/test_lib_config.py:408` · `test_objective_error_distingue_los_tres_estados`<br>`tests/test_lint.py:1759` · `test_lint_objective_roto_bloquea`<br>`tests/test_lint.py:1947` · `test_stars_yaml_roto_reporta_no_evaluado_en_vez_de_reventar`<br>`tests/test_lint.py:1960` · `test_themes_yaml_roto_tambien_reporta_no_evaluado`<br>`tests/test_query_ads.py:1338` · `test_query_ads_rehusa_lente_vacia` |
| **INV-81** | P0 | garantizado y medido (1.35.0) | `scripts/make_notes.py:1256` · `papers_universe` | `tests/test_make_notes.py:1937` · `test_conteo_del_encabezado_es_el_de_la_tabla`<br>`tests/test_make_notes.py:2410` · `test_planetas_se_estampa_no_es_dataview`<br>`tests/test_make_notes.py:2434` · `test_metodos_se_estampa_con_el_recorte_correcto`<br>`tests/test_make_notes.py:2592` · `test_una_corrida_limpia_deja_el_rollup_al_dia` |
| **INV-82** | P1 | garantizado y medido (1.35.0) | `scripts/lib_config.py:813` · `save_sintesis`<br>`scripts/make_notes.py:1676` · `estado_line` | `tests/test_make_notes.py:2026` · `test_refrescar_sin_reverificar_mueve_una_sola_fecha`<br>`tests/test_make_notes.py:2487` · `test_la_cabecera_lleva_las_tres_fechas`<br>`tests/test_make_notes.py:2505` · `test_refrescar_no_mueve_la_fecha_de_sintesis`<br>`tests/test_triage.py:487` · `test_sintesis_se_declara_y_no_pisa_lo_demas` |
...
| **INV-84** | P0 | garantizado y medido | `scripts/make_notes.py:1497` · `rename_paper` | `tests/test_make_notes.py:2147` · `test_ciclo_preprint_publicado` |
...
| **INV-88** | P1 | garantizado y medido | `scripts/query_ads.py:756` · `reclassify_for_theme`<br>`scripts/query_ads.py:785` · `gate_cited_by_corpus` | `tests/test_query_ads.py:1393` · `test_puerta_2_el_fundacional_entra_sin_lente_astro`<br>`tests/test_query_ads.py:1500` · `test_main_aplica_la_regla_del_tema_a_la_query_directa`<br>`tests/test_query_ads.py:1550` · `test_puerta_1_propone_lo_que_el_corpus_cita_y_no_lo_clasifica`<br>`tests/test_query_ads.py:1585` · `test_main_puerta_1_deja_el_candidato_en_ads_json` |
...
| **INV-91** | P1 | garantizado y medido | `scripts/check_retractions.py:338` · `_estampar`<br>`scripts/lib_config.py:958` · `load_cadena`<br>`scripts/lib_config.py:1341` · `save_paso` | `tests/test_check_retractions.py:579` · `test_slug_estampa_su_paso_en_la_cadena`<br>`tests/test_fetch_ground_truth.py:450` · `test_el_atajo_idempotente_estampa_el_paso`<br>`tests/test_lib_config.py:466` · `test_save_paso_appendea_con_fecha_version_y_via` |
...
| **INV-96** | P1 | garantizado y medido | `scripts/lint.py:340` · `merge_ours_unprotected`<br>`scripts/query_ads.py:652` · `to_record` | `tests/test_backends_schema.py:57` · `test_el_registro_tiene_exactamente_las_claves_del_schema`<br>`tests/test_search_arxiv.py:142` · `test_main_es_preview_clasifica_con_la_lente_y_no_escribe_nada` |
...
| **INV-104** | P1 | garantizado y medido | `scripts/lib_config.py:1114` · `puerta2_cruces`<br>`scripts/sweep_external.py:233` · `sweep_citas` | `tests/test_lib_config.py:863` · `test_puerta2_umbral_igual_no_reporta_nada`<br>`tests/test_sweep_external.py:332` · `test_sweep_citas_detecta_el_cruce_hacia_arriba` |
...
| **INV-102** | P1 | garantizado y medido | `scripts/make_notes.py:107` · `_txt_layout` | `tests/test_make_notes.py:2679` · `test_stamp_fulltext_declara_la_maqueta` |
