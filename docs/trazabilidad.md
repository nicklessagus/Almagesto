...
- Con implementación marcada: **12**
- Con test marcado: **12** (techo `sin_test`: 79, hoy 79)
- Sin ninguna marca: **79** (techo `sin_marca`: 79)
- Marcas huérfanas: **0**
...
| **INV-77** | P1 | HUECO (D-2) | `scripts/lint.py:235` · `note_files` | `tests/test_lint.py:1999` · `test_disputa_entre_autoridades_es_expresable` |
| **INV-78** | P0 | HUECO (D-4, D-20) | `scripts/lib_blocks.py:3`<br>`scripts/lint.py:855` · `main` | `tests/test_lib_blocks.py:47` · `test_reflow_no_mueve_ancla`<br>`tests/test_lint.py:1864` · `test_reemplazo_del_txt_marca_por_fuente` |
| **INV-79** | P0 | HUECO (D-4, D-5) | `scripts/lint.py:855` · `main` | `tests/test_lint.py:1819` · `test_nota_verificada_no_marca_nada` |
...
| **INV-82** | P1 | HUECO (D-12) | `scripts/make_notes.py:1212` · `estado_line` | `tests/test_make_notes.py:2000` · `test_refrescar_sin_reverificar_mueve_una_sola_fecha` |
| **INV-83** | P0 | HUECO (D-13, D-14) | `scripts/lib_config.py:625` · `save_extraccion` | `tests/test_lint.py:1972` · `test_subconjunto_sin_declarar_reporta` |
...
| **INV-89** | P1 | HUECO (D-28) | `scripts/lib_config.py:678` · `load_busquedas` | `tests/test_lib_config.py:418` · `test_dos_busquedas_con_solapamiento_no_suman` |
...
| **INV-91** | P1 | HUECO (D-57) | `scripts/lib_config.py:744` · `load_cadena`<br>`scripts/lib_config.py:749` · `save_paso` | `tests/test_lib_config.py:457` · `test_save_paso_appendea_con_fecha_version_y_via` |
