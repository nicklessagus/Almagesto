...
> 0–6. **Medición vigente (2026-08-27, tras la pasada `/auditar` y su tanda de fix, sobre los 134)**:
> 104 *garantizados y medidos* · 3 *garantizados* (sin medición propia) · 13 *sin
...
en las 64 categorías** salvo cuatro declaradas
