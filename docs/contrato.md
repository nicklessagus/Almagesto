...
> 0–6. **Medición vigente (2026-08-24, tras las tandas 8 y 9 y la auditoría triple, sobre los 91)**:
> 66 *garantizados y medidos* · 2 *garantizados* (sin medición propia) · 13 *sin
> medir* · 5 *parciales* · 4 *HUECO* · 1 *INCUMPLIDO*. El salto no es trabajo de documentación: son
...
**Instrumentos citados.** `tier 0` = `pytest tests/` (864 casos, ~5 s — medido 2026-08-24); `tier 1` = `pytest -m
...
> **12 garantizados y medidos · 4 parciales · 0 HUECO** — §3.K quedó **sin ningún HUECO**. **INV-88 cerró con la Tanda 7** (v1.32.0) e **INV-86 con el issue 8.3**: los dieciséis
...
> cada uno es lo que esa revisión decidió, así que la fila **es** el registro. *(Al 2026-08-24,
