...
# ── Verificación de citas: vive en `lib_quotes.py` (AUD-306); se re-exporta abajo ──────────
# Las cachés viven ACÁ (estado del proceso que los tests parchean por `cfg.`); lib_quotes las usa por `cfg.`.
...
# ── re-export del cluster de citas (AUD-306): `cfg.quote_verdict` & co. siguen resolviendo ───
from lib_quotes import (  # noqa: E402,F401
    BOUNDARY_SPACES_MIN,
    CANALETA_MIN,
    CITA_COLA_MIN,
    CITA_PREFIJO,
